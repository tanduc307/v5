---
title: MIBWR - Introduction - [1]
author: Duc Nguyen
date: '2022-07-18'
slug: mibwr-introduction-1
categories:
  - xác suất thống kê
tags:
  - tài liệu
...
The Canadian National Breast Cancer Screening studies (Miller et al. 2002,
2000, 2014) were large landmark clinical trials studying the impact of mam-mography. The first publication based on this large randomized screening trial
found no benefit of early tumor detection via digital mammography for women
aged 40-49, contradicting standard radiological practice at the time. Many dis-cussion articles have criticized the study on statistical grounds. For example,
Burhenne and Burhenne (1993) focused on statistical power and the ability to
generalize from the sample. One can see from this study the important role that